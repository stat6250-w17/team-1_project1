...
title1
"Research Question: Which plane models have the least number of fatalities when in an Accident."
;
...
*IL: be careful with unnecessary footnotes, or with naming techniques that
     might not be applicable without further explanation;
footnote2 "Notes: A possible follow-up to this approach could use an 
inferential statistical technique like beta regression";
*IL: why sort and then use proc sql, instead of an "order by" clause?;
